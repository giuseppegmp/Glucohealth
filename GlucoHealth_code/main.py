...
#file path
dct_filename = os.path.join('models', 'dct_model.pkl')
knc_filename = os.path.join('models', 'knc_model.pkl')
rfc_filename = os.path.join('models', 'rfc_model.pkl')
mlp_filename = os.path.join('models', 'mlp_model.pkl')
lr_filename  = os.path.join('models', 'lr_model.pkl')
nb_filename  = os.path.join('models', 'nb_model.pkl')
kms_filename = os.path.join('models', 'kms_model.pkl')
